...
class AddHandler(Database):
    ...
    # member nexus
    def add_member_nexus_phone(self, type_id: int, value: str, member_id: int, log_date: int | None) -> int or str:
        # validation in global handler
    ...
    def add_member_nexus_position(self, type_id: int, value: bool, member_id: int, log_date: int | None) -> int or str:
        # validation in global handler
